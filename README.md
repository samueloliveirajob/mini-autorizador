...
![](https://github.com/samueloliveirajob/mini-autorizador/blob/master/src/test/java/com/mini/autorizador/evidencia/evidencia.png)
...
Exemplo: dado que um cartão possua R$10.00 de saldo. Se fizermos 2 transações de R$10.00 ao mesmo tempo, em instâncias diferentes da aplicação, como o sistema deverá se comportar?
 - R. (Samuel) A concorrencia de saldo pode ser resolvidas de algumas formas, 1 delas seria com o uso synchonized outra poderia ser com lock da transacao no banco, outra delas é deixar a atualizacao com um update select no banco de dados onde o where conteria um saldo > retirada. 